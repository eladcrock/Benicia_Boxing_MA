...
import Arnis from "./components/Arnis";
import Karate from "./components/Karate";
import BenBox from "./components/BenBox";
import ArnisSchedule from "./components/ArnisSchedule";
import Ring from "./components/Ring";
import BenKarate from "./components/BenKarate";
import BoxLightBox from "./components/BoxLightBox";
import Form from "./components/form";
import KenLightBox from "./components/KenLightBox";
import BenArnis from "./components/BenArnis";
import ArnisLightBox from "./components/ArnisLightBox";
import OfferK from "./components/OfferK";
import BoxSchedule from "./components/BoxSchedule";
import KenSchedule from "./components/KenSchedule";
  ...
  return (
    <>
      <div>
        <header>
          <AppBar className="tool">
            <Toolbar className="tool">
              <Link to="/">
                <img src="./images/logoTop.png" alt="Logo" className="logoTop" />
              </Link>
              ...
              <Drawer anchor="right" open={isMenuOpen} onClose={toggleMenu}>
                <List>
                  {["Home", "About", "Boxing", "Karate Kenpo", "Balintawak Arnis", "Our Facility", "Contact"].map((text, index) => (
                    <ListItem
                      key={index}
                      button
                      component={Link}
                      to={
                        ["/", "/about", "/boxing", "/karate", "/arnis", "/facility", "/contact"][index]
                      }
                      onClick={toggleMenu}
                    >
              ...
              <div className="desktop-menu">
                <nav className="navbar">
                  <ul className="nav-links">
                    {["Home", "About", "Boxing", "Kenpo Karate", "Balintawak Arnis", "Our Facility", "Contact"].map((text, i) => (
                      <li key={i}>
                        <Link
                          to={["/", "/about", "/boxing", "/karate", "/arnis", "/facility", "/contact"][i]}
                          className="nav-link"
                          style={{ color: "white" }}
                        >
                          {text}
        ...
        {location.pathname === "/" && <div id="showcase" data-aos="fade-in" />} 
        {location.pathname === "/facility" && <div id="facilityShowcase" data-aos="fade-in" />} 
        {isAbout && (
          <div id="aboutShowcase">
            <video autoPlay loop muted playsInline preload="metadata" poster="/images/aboutPoster.jpg">
        ...
        {isKarate && (
          <div id="kenpoShowcase">
            <video autoPlay loop muted playsInline preload="metadata" poster="/images/kenpoPoster.jpg">
        ...
        {isBoxing && (
          <div id="boxShowcase">
            <video autoPlay loop muted playsInline preload="metadata" poster="/images/boxingPoster.jpg">
        ...
        {isArnis && (
          <div id="arnisShowcase">
            <video autoPlay loop muted playsInline preload="metadata" poster="/images/arnisPoster.jpg">
      ...
      <footer className="footer" data-aos="fade-in">
        ...
        <div className="address-link">
          ...
          >
            <IconButton size="small"><RoomIcon className="icon" /></IconButton>
            <span className="address">2002 Columbus Pkwy Benicia, CA 94510</span>
          </a>
        </div>
        <a href="tel:707-747-1722" className="foot-phone-link">
          <IconButton size="small"><PhoneIcon className="icon" /></IconButton>
          <span className="phone-number">707-747-1722</span>
        </a>
        <br />
        <a href="mailto:info@boxinggym.com" className="email-link">
          <IconButton size="small"><EmailIcon className="icon" /></IconButton>
          <span className="email-address">info@beniciabma.com</span>
        </a>
        <div className="social-media-icons">
          <a href="https://www.facebook.com/BeniciaBMA/" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faFacebook} size="2x" className="icon" />
          </a>
          <a href="https://www.instagram.com/beniciabma/?hl=en" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faInstagram} size="2x" className="icon" />
          </a>
          <a href="https://www.yelp.com/biz/benicia-boxing-and-martial-arts-benicia" target="_blank" rel="noopener noreferrer">
